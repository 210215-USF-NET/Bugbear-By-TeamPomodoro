...
namespace BBDL.Migrations
{
    ...
    [Migration("20210331210106_RelationshipFix11")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BBModels.Chat", b =>
                {
                    ...
                    b.Property<int>("DizeRollValue")
                        .HasColumnType("integer");

                    b.Property<int>("DizeSize")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BBModels.Chat", b =>
                {
                    b.HasOne("BBModels.Campaign", null)
                        .WithMany("CampaignChats")
                        .HasForeignKey("CampaignID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("BBModels.User", "User")
                        .WithMany()
                        .HasForeignKey("UserID");
